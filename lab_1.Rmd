...
```{r}
sf_trees <- readr::read_csv(here("data", "sf_trees", "sf_trees.csv"))
```
...
#using fct_reorder here changes the legal status output so that it shows up in the plot in order of lowest to highest tree count
...
Now combine blackwood acacia tree observations & SF roads map:
